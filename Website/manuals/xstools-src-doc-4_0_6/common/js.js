	...
	tabType_List = "_class,_member,_file,_namespace,_package,_page,_dir,_unit,,_search,_stats";
	tabDefault_List = "_description,_description,_description,_description,_description,_description,_description,_description,INDEX_DESCRIPTION,_quickSearch,_description";
	tabExtention = ".html";
...
document.write("<TR><TD><a href=\"#\" OnFocus=\"link('");
...
document.write("<a href=\"http://www.doxys.dk\" class=\"generatedDoxygen\" onmouseover=\"overLibGeneratedByDoxyS();return overlib('Generated by DoxyS 0.87b<br>Thu Apr 27 09:19 2006');\" onmouseout=\"return nd();\">Generated by DoxyS</A>\n");
document.write("</TD><TD class=\"sideIndent\"><img src=\"");
document.write(relPathToCommmon);
document.write("dot.gif\" class=\"sideIndent\"></TD></TR></table>\n");
document.write("</div>\n");
...
function link3( type, preLinkPart, dirarraynr, pageTab )
{
  ...
  return link2( type, arr_dir[dirarraynr] + "/" + preLinkPart, pageTab );
}
...
function link2( type, preLinkPart, pageTab )
{
  ...
  if( cookieContent == false ) {
    ...
    if( cookieContent == "INDEX_DESCRIPTION") {
      cookieContent = "";
    }
    else if(cookieContent =="") {
      alert("No default site for this page! Trying description");
      cookieContent = "_description";
    }
  }

  if( pageTab == "INDEX_DESCRIPTION") {
    cookieContent = "";
  }
  else if( pageTab != "") {
    cookieContent = pageTab;
  }
  else if (cookieContent == "INDEX_DESCRIPTION") {
    cookieContent = "";
 }
...
function FromSearchCookie()
{
  ...
  if(chkIncSearch == 'false') {document.getElementById("chkIncSearch").checked = false;}
